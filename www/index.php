<?php
    ...
    require __DIR__ . '/../core/curl.inc.php';
    require __DIR__ . '/../core/db.inc.php';
    require __DIR__ . '/../core/utility.inc.php';
    ...
    ini_set("error_log", Config::get('logfile'));
    ...
    switch ($action) {
        case 'staticfile' :
            /* @var $static_server Controller_staticfile */
            $static_server = getController('staticfile');
            $static_server->staticfile();
        break;
        case 'licr' :
        case 'voyager' :
            /* @var $controller Controller_voyager */
